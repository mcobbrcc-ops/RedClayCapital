...
export function SiteFooter() {
  return <footer className="site-footer"><div className="container footer-grid">
    <div><a className="brand" href="/"><span className="brand-mark" aria-hidden="true">RC</span><span className="brand-wordmark">RED CLAY <span>CAPITAL, LLC</span></span></a><p>Residential real estate acquisitions.<br />North Carolina · Georgia · Ohio</p><p>Property-specific review. Clear proposed terms.</p></div>
